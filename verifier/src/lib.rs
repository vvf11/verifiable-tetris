...
///
/// By hardcoding GROTH16_VK_BYTES, we restrict the user to only verify SP1 proofs.
#[wasm_bindgen]
...
///
/// By hardcoding PLONK_VK_BYTES, we restrict the user to only verify SP1 proofs.
#[wasm_bindgen]
